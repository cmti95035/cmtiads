...
function graph_report_widget($location, $type, $duration) {
	...
	echo '<td>&nbsp;</td>';
	echo '<th>';
	echo date ( 'm/d', mktime ( 0, 0, 0, date ( "m" ), date ( "d" ) - 6, date ( "Y" ) ) );
	echo '</th>';
	echo '<th>';
	echo date ( 'm/d', mktime ( 0, 0, 0, date ( "m" ), date ( "d" ) - 5, date ( "Y" ) ) );
	echo '</th>';
	echo '<th>';
	echo date ( 'm/d', mktime ( 0, 0, 0, date ( "m" ), date ( "d" ) - 4, date ( "Y" ) ) );
	echo '</th>';
	echo '<th>';
	echo date ( 'm/d', mktime ( 0, 0, 0, date ( "m" ), date ( "d" ) - 3, date ( "Y" ) ) );
	echo '</th>';
	echo '<th>';
	echo date ( 'm/d', mktime ( 0, 0, 0, date ( "m" ), date ( "d" ) - 2, date ( "Y" ) ) );
	echo '</th>';
	echo '<th>昨</th>';
	echo '<th>今</th>';
	echo '</tr>';
...
function do_edit($type, $data, $detail) {
	...
	if ($type == 'campaign') {
		...
		if (! isset ( $data ['gender_select'] )) {
			$data ['gender_select'] = '';
		}
		if (! isset ( $data ['income_select'] )) {
			$data ['income_select'] = '';
		}
		if (! isset ( $data ['interest_select'] )) {
			$data ['interest_select'] = '';
		}
		if (! isset ( $data ['location_select'] )) {
			$data ['location_select'] = '';
		}
		if (! isset ( $data ['age_select'] )) {
			$data ['age_select'] = '';
		}
		if (! isset ( $data ['chroniccondition_select'] )) {
			$data ['chroniccondition_select'] = '';
		}
...
function list_gender_campaign($selected) {
	...
	while ( $gender_detail = mysql_fetch_array ( $usrres ) ) {
		...
		echo '<td width="45%"><div>';
		if (in_array ( $gender_detail ['gender_id'], $selected )) {
			$selectedhtml = 'checked="checked"';
		} else {
			$selectedhtml = '';
		}
...
function list_income_campaign($selected) {
	...
	while ( $income_detail = mysql_fetch_array ( $usrres ) ) {
		...
		echo '<td width="45%"><div>';
		if (in_array ( $income_detail ['income_id'], $selected )) {
			$selectedhtml = 'checked="checked"';
		} else {
			$selectedhtml = '';
		}
...
function list_interest_campaign($selected) {
	...
	while ( $interest_detail = mysql_fetch_array ( $usrres ) ) {
		...
		echo '<td width="45%"><div>';
		if (in_array ( $interest_detail ['interest_id'], $selected )) {
			$selectedhtml = 'checked="checked"';
		} else {
			$selectedhtml = '';
		}
...
function list_location_campaign($selected) {
	...
	while ( $location_detail = mysql_fetch_array ( $usrres ) ) {
		...
		echo '<td width="45%"><div>';
		if (in_array ( $location_detail ['location_id'], $selected )) {
			$selectedhtml = 'checked="checked"';
		} else {
			$selectedhtml = '';
		}
...
function list_age_campaign($selected) {
	...
	while ( $age_detail = mysql_fetch_array ( $usrres ) ) {
		...
		echo '<td width="45%"><div>';
		if (in_array ( $age_detail ['age_id'], $selected )) {
			$selectedhtml = 'checked="checked"';
		} else {
			$selectedhtml = '';
		}
...
function list_chroniccondition_campaign($selected) {
	...
	while ( $chroniccondition_detail = mysql_fetch_array ( $usrres ) ) {
		...
		echo '<td width="45%"><div>';
		if (in_array ( $chroniccondition_detail ['chroniccondition_id'], $selected )) {
			$selectedhtml = 'checked="checked"';
		} else {
			$selectedhtml = '';
		}
